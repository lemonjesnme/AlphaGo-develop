...
class game_converter:
    ...
    def batch_convert(self, folder_path, features=None):
        ...
        file_names = "/Users/lemonjesnme/PycharmProjects/AlphaGo-develop/AlphaGo/tests/test_data/sgf"
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Prepare a folder of Go game files for training our neural network model.')
    parser.add_argument("--features", help="Comma-separated list of features to compute and store",
                        default="board,ones,turns_since")
    parser.add_argument("--no-meta", help="Flag to disable saving a metadata.json file in the outfolder", default=False,
                        action="store_true")
    ...
    parser.add_argument("-auto_split",
                        help="Parcel each sample into train, test, or dev subfolder with probabilities .93, .05, and .02 respectively.",
                        default=True)
